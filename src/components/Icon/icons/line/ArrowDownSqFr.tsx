  ...
  return (
    ...
    >
      <path
        ...
        clipRule="evenodd"
      />
      <path fill={color} d="M12.705 16.71a1 1 0 0 1-.322.214Z" />
      <path
        fill={color}
        d="m12.707 16.707 4-4a1 1 0 0 0-1.414-1.414L13 13.586V8a1 1 0 1 0-2 0v5.586l-2.293-2.293a1 1 0 0 0-1.414 1.414l4 4 .006.007a1 1 0 0 0 1.084.21"
      />
    </svg>
  );
};
