...
const SvgArrowLeftSqFr = ({
  ...
  return (
    ...
    >
      ...
      <path
        fill={color}
        d="M7.29 11.295a1 1 0 0 0-.214.322ZM7.293 11.293l4-4a1 1 0 1 1 1.414 1.414L10.414 11H16a1 1 0 1 1 0 2h-5.586l2.293 2.293a1 1 0 0 1-1.414 1.414l-4-4-.007-.006a1 1 0 0 1-.21-1.084"
      />
    </svg>
  );
};
