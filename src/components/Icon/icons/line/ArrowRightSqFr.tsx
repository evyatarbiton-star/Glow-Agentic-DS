  ...
  return (
    ...
    >
      <path
        ...
        clipRule="evenodd"
      />
      <path fill={color} d="M16.71 11.295a1 1 0 0 1 .214.322Z" />
      <path
        fill={color}
        d="m16.707 11.293-4-4a1 1 0 1 0-1.414 1.414L13.586 11H8a1 1 0 1 0 0 2h5.586l-2.293 2.293a1 1 0 0 0 1.414 1.414l4-4 .007-.006a1 1 0 0 0 .21-1.084"
      />
    </svg>
  );
};
