...
const SvgArrowUpSqFr = ({
  ...
  return (
    ...
    >
      ...
      <path
        fill={color}
        d="M12.705 7.29a1 1 0 0 0-.322-.214ZM12.707 7.293l4 4a1 1 0 0 1-1.414 1.414L13 10.414V16a1 1 0 1 1-2 0v-5.586l-2.293 2.293a1 1 0 0 1-1.414-1.414l4-4 .006-.007a1 1 0 0 1 1.084-.21"
      />
    </svg>
  );
};
