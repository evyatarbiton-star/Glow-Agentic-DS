...
const SvgCalendarEditInLc = ({
  ...
  return (
    ...
    >
      ...
      <path
        fill={color}
        d="m9.923 13.182-.886 2.126a.5.5 0 0 0 .654.654l2.126-.886a1 1 0 0 0 .322-.216l2.563-2.563a1 1 0 0 0 0-1.414l-.585-.586a1 1 0 0 0-1.415 0L10.14 12.86a1 1 0 0 0-.216.322M9 4a1 1 0 0 0-2 0v2a1 1 0 0 0 2 0zM17 4a1 1 0 1 0-2 0v2a1 1 0 1 0 2 0z"
      />
    </svg>
  );
};
