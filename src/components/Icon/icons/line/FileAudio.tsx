...
const SvgFileAudio = ({
  ...
  return (
    ...
    >
      ...
      <path
        fill={color}
        d="M10.873 12.5a.5.5 0 0 0 .239-.061l2.41-1.313a1 1 0 0 1 1.478.878v3.992a1 1 0 0 1-1.479.878l-2.41-1.313a.5.5 0 0 0-.238-.061H10a1 1 0 0 1-1-1v-1a1 1 0 0 1 1-1z"
      />
    </svg>
  );
};
