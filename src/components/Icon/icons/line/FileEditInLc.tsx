...
const SvgFileEditInLc = ({
  ...
  return (
    ...
    >
      ...
      <path
        fill={color}
        d="m9.924 14.183-.887 2.126a.5.5 0 0 0 .654.654l2.127-.887c.12-.05.23-.123.322-.216l2.563-2.563a1 1 0 0 0 0-1.414l-.586-.586a1 1 0 0 0-1.414 0L10.14 13.86a1 1 0 0 0-.216.323"
      />
    </svg>
  );
};
