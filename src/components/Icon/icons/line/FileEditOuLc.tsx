...
const SvgFileEditOuLc = ({
  ...
  return (
    ...
    >
      ...
      <path
        fill={color}
        d="m15.924 19.183-.886 2.126a.5.5 0 0 0 .653.654l2.126-.887Q18 21 18.14 20.86l3.563-3.563a1 1 0 0 0 0-1.414l-.586-.586a1 1 0 0 0-1.414 0L16.14 18.86a1 1 0 0 0-.216.323"
      />
    </svg>
  );
};
