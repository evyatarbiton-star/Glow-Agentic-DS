...
const SvgFileFavoriteInLc = ({
  ...
  return (
    ...
    >
      ...
      <path
        fill={color}
        d="M11.538 10.31a.5.5 0 0 1 .924 0l.79 1.898a.5.5 0 0 0 .418.306l1.874.163a.5.5 0 0 1 .301.86l-1.424 1.353a.5.5 0 0 0-.141.479l.48 2.014a.5.5 0 0 1-.747.543l-1.752-1.07a.5.5 0 0 0-.522 0l-1.752 1.07a.5.5 0 0 1-.747-.543l.48-2.015a.5.5 0 0 0-.14-.477l-1.42-1.355a.5.5 0 0 1 .302-.86l1.869-.162a.5.5 0 0 0 .418-.306z"
      />
    </svg>
  );
};
