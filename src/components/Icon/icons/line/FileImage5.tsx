...
const SvgFileImage5 = ({
  ...
  return (
    ...
    >
      ...
      <path
        fill={color}
        d="M10 13a2 2 0 1 0 0-4 2 2 0 0 0 0 4M13.724 14.299l1.983 1.996c.627.631.18 1.705-.71 1.705h-3.995c-.889 0-1.336-1.074-.709-1.705l1.983-1.996a1.02 1.02 0 0 1 1.448 0"
      />
    </svg>
  );
};
export default SvgFileImage5;
