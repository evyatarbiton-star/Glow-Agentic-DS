...
const SvgFileRemoveInLc = ({
  ...
  return (
    ...
    >
      ...
      <path
        fill={color}
        d="M10.707 11.293a1 1 0 0 0-1.414 1.414L10.586 14l-1.293 1.293a1 1 0 1 0 1.414 1.414L12 15.414l1.293 1.293a1 1 0 0 0 1.414-1.414L13.414 14l1.293-1.293a1 1 0 0 0-1.414-1.414L12 12.586z"
      />
    </svg>
  );
};
