  ...
  return (
    ...
    >
      <path
        fill={color}
        fillRule="evenodd"
        d="M2.63 8.007a1 1 0 0 1 1.363-.377l7.514 4.26a1 1 0 0 0 .986 0l7.514-4.26a1 1 0 1 1 .986 1.74l-7.513 4.26a3 3 0 0 1-2.96 0L3.007 9.37a1 1 0 0 1-.377-1.363"
        clipRule="evenodd"
      />
      <path
        fill={color}
