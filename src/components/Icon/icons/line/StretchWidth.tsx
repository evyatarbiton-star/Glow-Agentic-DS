...
const SvgStretchWidth = ({
  ...
  return (
    ...
    >
      ...
      <path
        fill={color}
        d="M6.293 12.707a1 1 0 0 1 0-1.414l2-2a1 1 0 0 1 1.414 1.414L9.414 11h5.172l-.293-.293a1 1 0 0 1 1.414-1.414l2 2a1 1 0 0 1 0 1.414l-2 2a1 1 0 0 1-1.414-1.414l.293-.293H9.414l.293.293a1 1 0 0 1-1.414 1.414z"
      />
    </svg>
  );
};
