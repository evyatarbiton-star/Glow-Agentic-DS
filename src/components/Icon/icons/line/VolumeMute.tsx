...
const SvgVolumeMute = ({
  ...
  return (
    ...
    >
      <path
        fill={color}
        d="M17.707 9.293a1 1 0 1 0-1.414 1.414L17.586 12l-1.293 1.293a1 1 0 0 0 1.414 1.414L19 13.414l1.293 1.293a1 1 0 0 0 1.414-1.414L20.414 12l1.293-1.293a1 1 0 0 0-1.414-1.414L19 10.586z"
      />
      <path
        fill={color}
        fillRule="evenodd"
