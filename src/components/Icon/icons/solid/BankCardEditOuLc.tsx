...
const SvgBankCardEditOuLc = ({
  ...
  return (
    ...
    >
      <path
        fill={color}
        d="m15.924 19.183-.886 2.125a.5.5 0 0 0 .654.654l2.126-.886a1 1 0 0 0 .322-.216l3.563-3.563a1 1 0 0 0 0-1.414l-.585-.586a1 1 0 0 0-1.415 0L16.14 18.86a1 1 0 0 0-.216.323M2.273 7.943c.11.057.251.057.534.057h18.386c.283 0 .424 0 .534-.057a.5.5 0 0 0 .22-.23c.052-.111.046-.247.034-.519-.03-.692-.107-1.162-.308-1.556a3 3 0 0 0-1.311-1.311C19.72 4 18.88 4 17.2 4H6.8c-1.68 0-2.52 0-3.162.327a3 3 0 0 0-1.311 1.311c-.2.394-.278.864-.308 1.556-.012.272-.018.408.035.52.045.095.125.18.22.229"
      />
      <path
        fill={color}
        fillRule="evenodd"
