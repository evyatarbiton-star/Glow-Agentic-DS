...
const SvgFolderDownloadOuLc = ({
  ...
  return (
    ...
    >
      <path
        fill={color}
        d="M20 16a1 1 0 1 0-2 0v3.586l-.293-.293a1 1 0 0 0-1.414 1.414l2 2a1 1 0 0 0 1.414 0l2-2a1 1 0 0 0-1.414-1.414l-.293.293z"
      />
      <path
        fill={color}
...
export default SvgFolderDownloadOuLc;
