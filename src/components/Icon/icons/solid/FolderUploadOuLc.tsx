...
const SvgFolderUploadOuLc = ({
  ...
  return (
    ...
    >
      <path
        fill={color}
        d="M19.707 15.293a1 1 0 0 0-1.414 0l-2 2a1 1 0 0 0 1.414 1.414l.293-.293V22a1 1 0 1 0 2 0v-3.586l.293.293a1 1 0 0 0 1.414-1.414z"
      />
      <path
        fill={color}
...
export default SvgFolderUploadOuLc;
