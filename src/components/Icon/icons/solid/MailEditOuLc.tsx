...
const SvgMailEditOuLc = ({
  ...
  return (
    ...
    >
      <path
        fill={color}
        d="m15.924 19.182-.886 2.126a.5.5 0 0 0 .654.654l2.126-.886Q18 21 18.14 20.86l3.563-3.563a1 1 0 0 0 0-1.414l-.585-.586a1 1 0 0 0-1.415 0L16.14 18.86a1 1 0 0 0-.216.322"
      />
      <path
        fill={color}
        fillRule="evenodd"
...
export default SvgMailEditOuLc;
